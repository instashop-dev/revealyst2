...
| ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `POST /api/auth/magic` hangs or 500s on new users | (old symptom, fixed) DB pool exhaustion — verify the deployed worker includes the `getDb` global-pool fix; check Workers Logs.                                           |
